...
<body>
    <div class="container">
        ...
        if($flag == 0) { // Your Own Profile       
            ...
            $profilesql = "SELECT users.user_id, users.user_gender, users.user_hometown, users.user_status, users.user_birthdate, users.user_about,
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // A form is posted
    if (isset($_POST['request'])) { // Send a Network Request
