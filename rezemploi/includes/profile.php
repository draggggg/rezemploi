...
if($flag == 1){
    ...
    if(isset($row['friendship_status'])) {
        if($row['friendship_status'] == 1){
            ...
            echo '<input type="submit" value="Already connect" disabled="disabled" id="special">';
            echo '</form>';
        ...
        echo '<form method="post">';
        echo '<input type="submit" value="Send Network Request" name="request">';
        echo'</form>';
    }
}
